    ...
    async execute(interaction) {
        ...
        if(interaction.options.getSubcommand() === 'user') {
            ...
            const userInfoEmbed = new MessageEmbed()
                ...
                .addFields(
                    {name: "User ID", value: `${userInFocus.id}`, inline: false},
                    {name: "Avatar URL", value: `[Link](https://cdn.discordapp.com/avatars/${userInFocus.id}/${userInFocus.avatar}.jpg)`, inline: false},
                    {name: "Created At", value: `${userInFocus.createdAt}`, inline: false},
                    {name: "Type", value: `${userType}`, inline: false},
                    {name: "Avatar Hash", value: `${userInFocus.avatar}`, inline: false},
                    {name: "Banner Hash", value: `${userBanner}`, inline: false},

                    {name: "Display Color", value: `${memberInFocus.displayHexColor}`, inline: false},
                    {name: "Display Name", value: `${memberInFocus.displayName}`, inline: false},
                    {name: "Joined At", value: `${memberInFocus.joinedAt}`, inline: false},
        ...
        // Bot Info
            ...
            const zenbuInfoEmbed = new MessageEmbed()
                ...
                .addFields(
                    {name: "User ID", value: `${userInFocus.id}`, inline: false},
                    {name: "Avatar URL", value: `[Link](https://cdn.discordapp.com/avatars/${userInFocus.id}/${userInFocus.avatar}.jpg)`, inline: true},
                    {name: "Uptime", value: `${uptimeH} hour(s),  ${uptimeMin} minute(s)`, inline: true},
                    {name: "Library", value: `[discord.js](https://discord.js.org/)`, inline: true},
                    {name: "GitHub Repository", value: `[legendoftheland/zenbu](https://github.com/legendoftheland/zenbu)`, inline: true},
                )
            interaction.reply({
