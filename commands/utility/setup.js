    ...
    async execute(interaction) {
        if(!interaction.member.permissions.has('ADMINISTRATOR')){
            const failure_memberInsufficientPermsEmbed = new MessageEmbed()
                ...
                .setDescription("You have not been given the `Administrator` permission - this command can only be used by server administrators. Please ask a server administrator to give you this permission.")
            ...
            if(!interaction.guild.me.permissions.has('MANAGE_ROLES')) {
                ...
                .setDescription("I have not been given the `Manage Roles` permission, which is required for verification. Please ask a moderator to give me this permission.")
                ...
                const setup_typeRow = new MessageActionRow()
                    .addComponents(
                        new MessageButton()
