...
module.exports = {
    ...
    async execute(interaction) {
        ...
        // if (domain === )
            ...
            .setDescription(`A verification code has been sent to your email, **${interaction.options.getString('email')}**. Please check your mailbox and send the code back to me here.`)
        ...
        client.on('messageCreate', msg => {
            if (msg.content === `${verificationCode}` && msg.author.id === interaction.member.user.id) {
                interaction.member.user.id.roles.add();
